  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <div>
          <p className="text-sm font-medium text-gray-900">Resumen matutino</p>
      ...
      {activo && (
        <div className="flex items-center gap-2">
          <label className="text-sm text-gray-600">Hora de envio:</label>
          <select
            value={hora}
            onChange={cambiarHora}
            disabled={isPending}
            className="text-sm border border-gray-200 rounded-md px-2 py-1 bg-white text-gray-900 focus:outline-none focus:ring-1 focus:ring-gray-400 disabled:opacity-50"
          >
