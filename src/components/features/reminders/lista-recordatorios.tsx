...
export function ListaRecordatorios({
  ...
  // Los vencidos no se muestran en el listado superior del inicio: van en su propio
  // apartado plegable (ver seccion-vencidos.tsx). Por eso no cuentan para hayContenido.
  const hayContenido =
