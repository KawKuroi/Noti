...
- book: si el usuario menciona el autor, incluye ese nombre en el campo "artista" al llamar buscarLanzamiento para desambiguar. Si el resultado incluye el campo "autor", pasalo al llamar agregarRecordatorio.
