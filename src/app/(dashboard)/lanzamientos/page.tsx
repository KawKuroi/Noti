...
import { ChatLanzamientos } from '@/components/features/lanzamientos/chat-lanzamientos'
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">
            Peliculas, series, videojuegos, musica y libros. Pregunta al chat o agrega manualmente.
          </p>
        </div>
      </div>
